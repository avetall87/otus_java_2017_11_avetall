package ru.spb.otus.atmDepartmnent.atm.service.impl;
...
import ru.spb.otus.atmDepartmnent.atm.service.exception.EmptyRequestedSumException;
import ru.spb.otus.atmDepartmnent.atm.service.exception.GiveBanknoteException;
import ru.spb.otus.atmDepartmnent.atm.service.exception.LargeRequestedSumException;
import ru.spb.otus.atmDepartmnent.atm.service.exception.NotEnoughMoneyException;
...
public class AtmImpl implements Atm {
    ...
    private void checkRequestedSum(Integer sum){
        ...
        if (sum % BanknoteType.TEN.getValue() != 0)
